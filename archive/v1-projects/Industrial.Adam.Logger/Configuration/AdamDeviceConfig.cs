...
public class AdamDeviceConfig : IValidatableObject
{
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (string.IsNullOrWhiteSpace(IpAddress) || (!System.Net.IPAddress.TryParse(IpAddress, out _) && !IsValidHostname(IpAddress)))
            yield return new ValidationResult("Valid IP address or hostname is required", new[] { nameof(IpAddress) });
